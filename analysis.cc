...
{ 
 ...
 TString inputDir  = "/lustre/nyx/hades/user/nrathod/PIMP_simul/hgeant/hgeant_out/LIST/eta_gg_out";
 TString outputDir = "/lustre/nyx/hades/user/nrathod/ANALYSIS_QA/hgeant/";
...
/*******************************************************************************************************/
 ...
 Int_t aTrackLepton, aID, aParentID, aMedLepton, aMechLepton;
 Int_t aID1;
 Int_t aID2;
 Int_t aID3;
 Float_t genInfo=0.;
 Float_t genWeight=0., genWeight1=0., genWeight2=0., genWeight3=0.;
 ...
 for (Int_t i = 0; i<nentries; i++)
   {//event loop
     ...
     while((pKine = (HGeantKine*)pitGeant->Next()) != 0)
	 {
	       ...
	       if (aID>14)	       cout << " parent = " << aParentID << " id = " << aID << " geninf = " << genInfo << endl;
       /************************************************************ PID ***************************/
