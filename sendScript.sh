...
outputdir=/hera/hades/user/przygoda/apr35/ACC/FILES/ELASTIC # outputdir for files AND logFiles
...
par7=/hera/hades/user/przygoda/PAT35/set64.sh     # optional par7
resources="-l h_rt=10:0:0,h_vmem=2G"             # runtime < 10h, mem < 2GB

filelist=${currentDir}/pp35_elast.list  # file list in local dir! not in submissiondir!!!
######################################################################
